...
def verify_expected_result(context, link):
    ...
    assert link in context.driver.find.element(By.ID,'zg_banner_text'),f"Expected query not in{expected_result}but got{context.driver.find.element(By.ID,'z_banner_text')}"
